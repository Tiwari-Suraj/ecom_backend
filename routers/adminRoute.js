...
const { getAllProductsAdmin, getCategories, getSingleProduct, createProduct, deleteProduct } = require("../controller/productController");
...
//  //! [       ..................  Products    ..................]
adminRoute.route("/api/v1/admin/product/products").get(isAuthenticatedAdmin, getAllProductsAdmin);
...
adminRoute.route("/api/v1/admin/product/new").post(upload.array("images"), createProduct);
